...
export class DwtComponent implements OnInit {
  ngOnInit() {
    ...
    Dynamsoft.WebTwainEnv.ProductKey = "462BD5A5;6152;4B58;9168;B63F2CD5E2DE";
  ...
  btnUpload_onclick(): void {
    ...
    let uploadfilename = fileName + "." + imageType.item(strImageType)["value"];
  ...
  InitMessageBody() {
    ...
    if (typeof (MessageBody) != "undefined") {
      let ObjString = "<div><p style='margin: 0; color: #444; font-family: OpenSans-Semibold, Arial, sans-serif, Verdana, Helvetica;'>Platform & Browser Support: </p>Internet Explorer 8 or above (32 bit/64 bit), any version of Chrome (32 bit/64 bit), any version of Firefox on Windows; Safari, Chrome and Firefox on Mac OS X 10.7 or later; Chrome and Firefox v27 or above (64 bit) on Ubuntu 16.04+, Debian 8+";
      ObjString += ".</div>";
