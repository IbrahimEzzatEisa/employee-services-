var _iLeft, _iTop, _iRight, _iBottom, _trxID, _trxType, _trxSerial, _Add; //These variables are used to remember the selected area
...
function InitMessageBody() {
    ...
    if (MessageBody) {
        ...
        ObjString += "<a href='http://www.taj-it.com/' target='_blank' >sample gallery page";
        ObjString += "</a>";
        ObjString += ".</div>";
...
function initMessageBox(bNeebBack) {
    ...
    objString += "<div><input id='DW_btnRemoveCurrentImage' onclick='btnRemoveCurrentImage_onclick()' type='button' value='حذف الصورة المحددة'/>";
    if (bNeebBack) {
        objString += "<input id='DW_btnRemoveAllImages' onclick='btnRemoveAllImages_onclick()' type='button' value='حذف جميع الصور'/><br /><br />";
        objString += "<span style=\"font-size:larger\"><a href =\"scan.aspx\"><b>Back</b></a></span><br /></div>";
    }
    else {
        objString += "<input id='DW_btnRemoveAllImages' onclick='btnRemoveAllImages_onclick()' type='button' value='حذف جميع الصور'/><br /></div>";
    }
    objString += "</div>";
...
function initCustomScan() {
    ...
    ObjString += "<label for = 'ADF'><input type='checkbox' id='ADF' checked/>AutoFeeder&nbsp;</label>";
...
function setDefaultValue() {
    document.getElementById("RGB").checked = true; // Gray
    ...
    _trxID = document.getElementById("hfTrxID");
    _trxType = document.getElementById("hfType");
    _trxaction = document.getElementById("hfaction");
    _Add = document.getElementById("hfAdd");
    ...
    $('#imgTypepdf2, #MultiPagePDF, [name=ImageType]').prop('disabled', true);
    $('#imgTypepdf2, #MultiPagePDF').prop('checked', true);
}
